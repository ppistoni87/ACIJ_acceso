...
| P-007 | Citas, vigencia y relaciones | LISTA_PARA_ACEPTACION | Las 215 referencias sin resolver son la cola auditable que el criterio pide. La cadena de la Ley 24.714 —abrogación de 2001, restitución retroactiva, derogaciones parciales de 2016 y 2024— quedó determinada con el texto a la vista: los 12 beneficios que dependen de ella se sostienen (D-145). |
