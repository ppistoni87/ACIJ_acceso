...
| P-014 | Condiciones y datos con lógica tipada | EN_CURSO | **Contesta.** Con el corte `180ae01f` hay 15 beneficios publicados y 93 reglas ejecutables sirviendo. La evaluación devuelve cumple / no cumple / desconocido con el texto literal y la pregunta que falta. Los nueve valores de parámetro ya tienen fecha de verificación tomada de su captura (D-141), así que los montos dejan de abstenerse en cuanto se publique el corte. |
| P-015 | Front conversacional | EN_CURSO | Construido y probado con 59 casos E2E en Chromium. Con D-141 los 1.842 lugares de atención pueden llegar a la pantalla en cuanto se publique el corte, con la fecha de su captura y el aviso de confirmar antes de ir. Faltan URL de staging (B) y revisión manual de accesibilidad con personas. |
