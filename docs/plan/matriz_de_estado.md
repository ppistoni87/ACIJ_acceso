...
| P-030 | Orientar desde situaciones y armar próximos pasos | NO_INICIADA | Desbloqueada: P-025 cerró y el frente ya orienta. Falta lo propio de esta historia: opciones por necesidad y la lista de próximos pasos. Es el punto que quedó pendiente del análisis de Boti como «invertir el orden de la respuesta». |
...
| P-032 | Front web conversacional de ACIJ | EN_CURSO | «Revisar lo que me contaste» con corrección de hechos, estado de vencimiento de sesión y elección de programa cuando la consulta toca varios, todo hecho (D-137). Faltan: control «Ver fuentes» plegable por respuesta, próximos pasos (P-030), y el flujo HTTP/SSE con eventos tipados. |
