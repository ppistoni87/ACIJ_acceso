...
actualice. Las demás sí dependen de resoluciones que no están en el corpus. No es una omisión: es lo que las normas dicen.
...
- La asignación por maternidad está hecha de excepciones: su importe es el
