...
**53 tablas** y **510 columnas**, generadas desde los modelos
...
- `ck_fuente_urls_url_http_concreta: url ~ '^https?://'`
...
| `dimensiones_hash` | TEXT | no | `Computed(<sqlalchemy.sql.elements.TextClause object at 0x7fc00a630790>, persisted=True)` | — |
