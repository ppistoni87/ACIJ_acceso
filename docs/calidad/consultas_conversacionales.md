...
- Release evaluado: `da2b7f96-c1d2-4ad3-82f1-aad37212df09`
- Gate DQ18: **cumple**
...
| --- | --- | --- | --- | --- | --- | --- |
| CV-001 | AT-001 | identidad | ¿Esta norma es nacional o de CABA? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
...
| CV-010 | AT-010 | cita | ¿Cambió el requisito? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
...
| CV-013 | AT-013 | cita | ¿Qué normas la modificaron? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
...
| CV-021 | AT-021 | monto | ¿Cuál es el tope para este período? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «TOPE_INGRESO» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
...
| CV-025 | AT-025 | cobertura | Mostrar el artículo nuevo. | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
...
| CV-030 | AT-030 | identidad | ¿Se aplica esta ley? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-031 | AT-031 | monto | ¿Cuánto cobro hoy de AUH? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «AUH» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
...
| CV-033 | AT-033 | revocacion | ¿Se eliminó el beneficio por ese estado? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-034 | AT-034 | no_exclusion | ¿Qué régimen habitacional corresponde? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 10 valor(es) con estado INFORMADO. |
| CV-035 | AT-035 | cita | ¿Cambió el subsidio habitacional? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-036 | AT-036 | cita | Mostrar normas relacionadas. | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-037 | AT-037 | cita | ¿Qué dependencias faltan? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-038 | AT-038 | monto | ¿Qué beneficio directo otorga? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 4 valor(es) con estado INFORMADO. |
...
| CV-041 | AT-041 | no_exclusion | ¿Puedo solicitarlo por mi hijo? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 16 valor(es) con estado INFORMADO. |
| CV-042 | AT-042 | no_exclusion | ¿Puedo acceder si no sé mi ingreso computable? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 10 valor(es) con estado INFORMADO. |
| CV-043 | AT-043 | no_exclusion | ¿Sirve esta alternativa de acreditación? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 10 valor(es) con estado INFORMADO. |
| CV-044 | AT-044 | no_exclusion | ¿No tener ese dato me excluye? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 10 valor(es) con estado INFORMADO. |
| CV-045 | AT-045 | monto | ¿Qué pasa si estoy justo en el tope? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «SMVM» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
...
| CV-048 | AT-048 | no_exclusion | Tengo 25 años, ¿puedo inscribirme? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 16 valor(es) con estado INFORMADO. |
...
| CV-054 | AT-054 | monto | ¿El salario mínimo dejó de regir este mes? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «SMVM» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
| CV-055 | AT-055 | monto | ¿Cuál es el tope de ingreso de la beca? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «SUELDO_COMERCIO» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
| CV-056 | AT-056 | monto | ¿Este tope corresponde al mes consultado? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «MONOTRIBUTO» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
| CV-057 | AT-057 | monto | ¿Cuánto me pagan? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 4 valor(es) con estado INFORMADO. |
| CV-058 | AT-058 | monto | ¿Por qué cambió el monto? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «SMVM» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
...
| CV-069 | AT-069 | identidad | ¿Qué versión está disponible? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
...
| CV-072 | AT-072 | identidad | Mostrar última actualización. | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-073 | AT-073 | identidad | ¿Se notificó el cambio? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
...
| CV-075 | AT-075 | identidad | ¿De qué año es este reglamento? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
...
| CV-080 | AT-080 | identidad | ¿Qué se sabía sobre esa regla en la fecha indicada? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-081 | — | ambigua | ¿Me corresponde la beca? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 10 valor(es) con estado INFORMADO. |
| CV-082 | — | ambigua | ¿Cuánto es? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «SMVM» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
...
| CV-086 | — | ambigua | ¿Es lo mismo que la otra ayuda? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-087 | — | historica | ¿Qué decía esta norma cuando se publicó? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-088 | — | historica | ¿Qué sabíamos de esta regla el año pasado? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
| CV-089 | — | historica | ¿El monto de 2024 sigue siendo el mismo? | SE_ABSTIENE | SE_ABSTIENE | No hay un valor aprobado de «SMVM» que se aplique al 2026-09-08. No se devuelve el valor de otro período. |
| CV-090 | — | historica | ¿Esta ley estaba vigente en 2019? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 1 versión(es) servible(s) y 14 evidencia(s). |
...
| CV-098 | — | monto | ¿Cuánto voy a cobrar por mes? | RESPONDE_CON_EVIDENCIA | RESPONDE_CON_EVIDENCIA | 4 valor(es) con estado INFORMADO. |
