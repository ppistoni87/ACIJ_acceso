...
| HU-035 | Poblar el corpus con datos reales y conciliar | orquestacion | P0 | EN_CURSO | `scripts/poblar_corpus.sh`<br>`src/backend_normativo/ingesta/importadores/infoleg.py`<br>`docs/operacion/poblacion_real.md`<br>_Falta: El catálogo nacional está importado entero y ocho normas del alcance tienen texto, campos y release. Faltan las fuentes que dependen del adaptador PDF (HU-007) y de los importadores de trámites y directorios (HU-019 a HU-021)._ |
| HU-036 | Verificar con corpus experto y casos adversos | calidad_qa | P0 | EN_CURSO | `docs/calidad/trazabilidad_at.json`<br>`tests/aceptacion/test_casos_aceptacion.py`<br>`docs/calidad/trazabilidad_at.md`<br>`bn calidad trazabilidad --ejecutar`<br>_Falta: 50 de los 80 casos AT están cubiertos y 11 parcialmente; los 19 restantes esperan capacidades que este alcance no construyó. Las 60 consultas conversacionales revisadas que pide la gate no se hicieron._ |
...
| HU-039 | Entregar documentación y operación reproducible | orquestacion | P0 | EN_CURSO | `docs/operacion/runbook.md`<br>`docs/operacion/diccionario_de_datos.md`<br>`docs/adr`<br>`src/backend_normativo/calidad/backlog.py`<br>`bn calidad backlog`<br>`bn calidad trazabilidad`<br>_Falta: La documentación y los reportes están; falta la corrida de verificación en un entorno limpio distinto del de desarrollo._ |
...
| HU-F02 | F02 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F03 | F03 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F04 | F04 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F05 | F05 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F06 | F06 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F07 | F07 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F08 | F08 | BLOQUEADA | 0 | 0 | 0 | 0 | 0 | 0 | 0 | Sin URL inequívoca conocida. Responsable: ingesta. |
| HU-F09 | F09 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F10 | F10 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F11 | F11 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F12 | F12 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
...
| HU-F16 | F16 | NO_INICIADA | 2 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
...
| HU-F24 | F24 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F25 | F25 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F26 | F26 | BLOQUEADA | 0 | 0 | 0 | 0 | 0 | 0 | 0 | Sin URL inequívoca conocida. Responsable: ingesta. |
| HU-F27 | F27 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
...
| HU-F31 | F31 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F32 | F32 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
...
| HU-F44 | F44 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F45 | F45 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F46 | F46 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F47 | F47 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F48 | F48 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F49 | F49 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-F50 | F50 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
...
| HU-F67 | F67 | NO_INICIADA | 2 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
...
| HU-M03 | M03 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-M04 | M04 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-M05 | M05 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
| HU-M06 | M06 | NO_INICIADA | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Sin capturas: la fuente está en el catálogo y todavía no se recorrió. |
