...
| HU-035 | Poblar el corpus con datos reales y conciliar | orquestacion | P0 | EN_CURSO | `scripts/poblar_corpus.sh`<br>`scripts/corrida_limpia.sh`<br>`src/backend_normativo/ingesta/importadores/infoleg.py`<br>`docs/operacion/poblacion_real.md`<br>`docs/reportes/actualizacion_controlada.md`<br>`docs/reportes/corrida_limpia.md`<br>`docs/curaduria/ley-caba-6935.json`<br>`docs/curaduria/ley-caba-2917.json`<br>`docs/curaduria/ley-nacional-24714-auh.json`<br>`docs/curaduria/ley-nacional-24714-embarazo.json`<br>`docs/curaduria/ley-nacional-24714-asignacion-por-hijo.json`<br>`docs/curaduria/ley-nacional-24714-hijo-con-discapacidad.json`<br>`docs/curaduria/decreto-caba-690-2006.json`<br>`docs/curaduria/ordenanza-caba-43478.json`<br>`src/backend_normativo/curacion/beneficios.py`<br>`tests/unit/test_lecturas_curadas.py`<br>`bash scripts/poblar_corpus.sh`<br>`bn ingesta importar-infoleg`<br>`bn calidad ensayo-actualizacion`<br>_Falta: La población entera se corre con un comando: `scripts/poblar_corpus.sh` es la única definición del procedimiento y `scripts/corrida_limpia.sh` lo ejercita sobre una base que se crea vacía. Están el catálogo nacional entero (423.718 normas), el padrón RENABAP (6.467 barrios) y los tres directorios. Ocho beneficios están curados desde el texto capturado: cuatro porteños —el apoyo habitacional de la Ley 6935, el Régimen de Becas de la Ley 2917, el subsidio para familias en situación de calle del Decreto 690/06 y la beca de comedor de la Ordenanza 43.478— y cuatro de la Ley nacional 24.714, curados por separado porque son prestaciones distintas sobre la misma ley: la Asignación Universal por Hijo y la Asignación por Embarazo del subsistema no contributivo, y la asignación por hijo y la asignación por hijo con discapacidad del contributivo. Son 91 reglas vigentes, 17 poblaciones, 13 plazos y 8 cuantías —siete monetarias y una en especie—, cada pieza atada a su artículo y verificada contra el texto capturado por el cargador, más un control de esquema sobre las propias lecturas en `tests/unit/test_lecturas_curadas.py`. Falta curar el resto del corpus con texto —de la Ley 24.714 quedan diez prestaciones—: el trabajo es de lectura jurídica sobre cada norma, no de más ingesta._ |
