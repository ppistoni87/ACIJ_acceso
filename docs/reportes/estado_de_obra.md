...
| P-006 | Completar adaptadores y fuentes operativas | Parcial | **39 de 85 sirven** (eran 31). Las «capturadas y sin destino» bajaron de 17 a 9: se arregló la extracción de páginas institucionales, se curaron 52 canales de atención y se descubrieron las hojas que los índices enlazan, de donde salieron 4 trámites con 11 pasos. Quedan 29 sin capturar, 15 sin URL conocida, 5 capturadas sin extraer y 9 sin destino. |
